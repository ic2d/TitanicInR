...
#print(" - Ticket binário")
#train.pre$Ticket = as.numeric(train.pre$Ticket)
#test.pre$Ticket = as.numeric(test.pre$Ticket)
...
task = mlr::makeClassifTask(data = train.data, target = "Survived")
...
#model  = mlr::train(learner = rf, task = task)
